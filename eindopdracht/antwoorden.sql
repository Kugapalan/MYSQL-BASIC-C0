...
127.0.0.1/mod-mysql-basic-opdracht/videogamesales/		http://localhost/phpmyadmin/index.php?route=/table/sql&db=mod-mysql-basic-opdracht&table=videogamesales
   ...
   Weergave van records 0 - 24 (998 totaal, Query duurde 0,0008 seconden.)


SELECT * FROM videogamesales WHERE Global_Sales>0;
...
127.0.0.1/mod-mysql-basic-opdracht/videogamesales/		http://localhost/phpmyadmin/index.php?route=/table/sql&db=mod-mysql-basic-opdracht&table=videogamesales
   ...
   Weergave van records 0 - 24 (77 totaal, Query duurde 0,0008 seconden.)
